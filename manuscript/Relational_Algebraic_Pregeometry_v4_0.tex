%=============================================================================
% Relational-Algebraic Pregeometry Programme v4.0
% Author: Philipp Rietz (ORCID: 0009-0007-4307-1609)
% Branch: mss000-rebase-v2
% Path:   manuscript/Relational_Algebraic_Pregeometry_v4_0.tex
%
% PROVENANCE:
% This file states no commit identity of its own. A file cannot contain its
% own Git blob: the blob is the hash of its content, header included, so any
% commit or blob written here would name a superseded state as soon as the
% next commit lands. The commit graph of this file on the branch named above
% is authoritative. The narrative chain is kept in manuscript/PROVENANCE.md,
% which is permitted to lag because it is not part of the hashed manuscript.
%
% STATUS: applied to the working branch; NOT merged. Build statements remain
% environment-qualified while PROV-002 is open.
% Basis manuscript: UIDT_Ontology_v3_9_9_DEWRAPPED-006
% Ontology DOI: 10.5281/zenodo.20319634
% Parent framework DOI: 10.5281/zenodo.17835200
% License: CC BY 4.0
%
% SINGLE-WRITER BOUNDARY:
% The executor authors this patch. Claude Desktop audits and applies it to the
% active .tex only after PI authorization. The executor performs subsequent
% build/repository reconciliation. No merge authority is conveyed.
%=============================================================================
%=============================================================================
% PROCESSING-COVERAGE LEDGER  (non-rendering; audit artifact)
% Updated: 2026-07-30 manuscript-depth core candidate against applied blob c3197df2.
% Percentages are source lines actually read, not inferred from summaries.
%
% --- MANUSCRIPT PHASES -------------------------------------------------------
%  P1 skeleton ............................ 100% complete
%  P2 Part I .............................. 100% structurally complete
%  P3 Part II ............................. 100% structurally complete
%  P4 Part III ............................ 100% structurally complete
%  P5 back matter + bibliography .......... 100% structurally complete
%  R0 source reading ....................... 60% historical estimate; reset below
%  R1--R4 architecture and MSS-000 ........ applied through Decisions D19/D21--D25
%                                             in baseline blob c3197df2
%  R5 manuscript post-application checks .. baseline bytes verified; Lean snapshot
%                                             f1ae5486 reconciled; later heads, remote CI,
%                                             and PROV-002 remain open
%
% --- SOURCE STATUS -----------------------------------------------------------
%  -006 canonical ........................ ~88% historical reading estimate
%  Lean corpus @ 61bc24da ................ 100% historical static snapshot only;
%                                             not a live-repository assertion
%  Module A FOUNDATION .................... ~5% structure map only
%  Module B MATRIX THERMO ................. ~4% targeted extraction only
%  Module C COSMOLOGY/PBH ................. ~10% structure + claim scan
%  Module D OPERATOR NORMS ................ 100% read
%  Module E MISC/LITERATURE ............... ~2% structure map only
%  01_KNOWLEDGE_GRAPH.json ................ 0% UNREAD / exact artifact unavailable
%  Ultimate_Pipeline/*.tex ................ 0% UNREAD / exact artifacts unavailable
%  json_output/ (111 files) ............... ~5% selected reports only
%  UNIVERSUM_SIM-master LEDGER/docs ....... 0% UNREAD / live snapshot required
%
%  Rule: unread or unavailable sources contribute no manuscript claim. Reading
%  coverage is not evidence quality; primary-source verification is tracked
%  independently in the executor source register.
%
% --- STANDING GATES ----------------------------------------------------------
%  G-DIFF   map every baseline section to retained/relocated/split/removed
%  G-SOURCE no manuscript claim from a summary where the primary source exists
%  G-CLASS  one legal evidence class per atomic proposition
%  G-LEAN   historical snapshots are never described as current repository state
%  G-PROV   all builds are environment-qualified until PROV-002 is complete
%=============================================================================
...
% Museum-appendix watermark: activated only after \appendix (see below), applies
% diagonally to every page of the Historical Appendix to prevent a reader from
% mistaking demoted, non-imported material for active ontology.
\newtoggle{museumwatermark}
\togglefalse{museumwatermark}
\AddToShipoutPictureBG{%
  \iftoggle{museumwatermark}{%
    \AtPageCenter{%
      \makebox[0pt]{\rotatebox{55}{\scalebox{2.4}{%
        \color[gray]{0.85}\sffamily\bfseries
        MUSEUM ROUTE B --- NOT ACTIVE ONTOLOGY}}}%
    }%
  }{}%
}
...
%=============================================================================
% HEADER/FOOTER (release variant)
%=============================================================================
\fancypagestyle{uidtontology}{%
 \fancyhf{}
 \fancyhead[LE,RO]{\thepage}
 \fancyhead[RE]{\small\textit{Relational-Algebraic Pregeometry v4.0}}
 \fancyhead[LO]{\small\textit{P.\ Rietz}}
 \fancyfoot[C]{%
 \footnotesize\textcolor{darkgray}{%
 \copyright\ 2026 P.\ Rietz $\cdot$ CC BY 4.0 $\cdot$ Relational-Algebraic Pregeometry v4.0 Release $\cdot$
 basis: \href{https://doi.org/10.5281/zenodo.20319634}{DOI 10.5281/zenodo.20319634} | \href{https://github.com/badbugsarts-hue/Relational-Algebraic-Pregeometry}{Relational-Algebraic Pregeometry Repository}}%
 }
...
%=============================================================================
\hypersetup{
 pdftitle={Relational-Algebraic Pregeometry: Finite Kernels, Open Continuum Emergence, and Formal Verification}, pdfauthor={Philipp Rietz}, pdfsubject={Finite relational-algebraic pregeometry, open continuum emergence, formal verification, and a non-ontological parameter ledger}, pdfkeywords={Relational-Algebraic Pregeometry, Finite Algebra, Spectral Triple, Krajewski Diagram, Formal Verification, UIDT historical lineage}, colorlinks=true, linkcolor=black, citecolor=black, urlcolor=black, pdflang={en}
}
...
\newcommand{\ProjectName}{Relational-Algebraic Pregeometry Programme}
\newcommand{\ProjectShort}{Relational-Algebraic Pregeometry}
\newcommand{\RAP}{\ProjectShort}
\newcommand{\LegacyProjectName}{Unified Information-Density Theory}
\newcommand{\UIDT}{\textsc{uidt}} % historical lineage, DOI, repository, and legacy notation only
...
\newcommand{\ETorsion}{2.44\MeV} % [E] subatomic-only reference; no neural/biological bridge
...
Finite Kernels, Open Continuum Emergence,\\[0.25em]
and Formal Verification}\\[0.9em]
{\small\bfseries A Falsification-First Programme\,\catmark{D}\ for a Finite Relational-Algebraic Kernel,\\[0.25em]
an Explicitly Open Passage to Apparent Continuity,\\[0.25em]
and a Non-Ontological Verification and Parameter Ledger}\\[1.5em]
{\large\itshape Relational-Algebraic Pregeometry Programme --- Version 4.0}\\[0.5em]
{\small Version 4.0 of the research programme formerly designated\\
Unified Information-Density Theory (UIDT)}\\[2.6em]
...
{\normalsize Historical lineage: UIDT versions 1--3.9}\\[0.5em]
{\small Ontology v3.9 record:
\href{https://doi.org/10.5281/zenodo.20319634}{DOI 10.5281/zenodo.20319634}}\\[0.25em]
{\small Parent framework record:
\href{https://doi.org/10.5281/zenodo.17835200}{DOI 10.5281/zenodo.17835200}}\\[0.5em]
{\small 13~September~2026 --- Release, not archived, not frozen}\\[2.2em]
...
\begin{governancebox}[Governance Status of This Finalization Candidate]
The input to this patch is the watermarked manuscript blob
\texttt{7962e5e7} (full Git blob recorded in the package provenance file),
independently reproduced from the supplied source file. The earlier MSS-000 architectural rebase is
therefore treated as the applied baseline for this finalization pass; stale
``executor candidate'' wording in that baseline is corrected here. This
patch closes the scientifically determinate PI dispositions, normalizes
compound evidence tags, and separates historical Lean snapshots from live
repository claims. It is not a canonical freeze, not a merge authorization,
and not an evidence-class upgrade. Claude Desktop audits the complete diff
and applies it as the sole writer of the active \texttt{.tex} after PI
authorization. Build, repository reconciliation, and technical
post-application verification then return to the executor lane. Final
integration remains PI-only.
\end{governancebox}

\begin{pioverridebox}[PI Decision D19 --- Ontological Re-Architecture (CLOSED)]
\label{box:pi-decision-d19}
\textbf{Decision.} The continuous real scalar field $\Sx$, treated in UIDT
v3.9.x as the ontological primitive, is demoted to a historical macroscopic
effective-field description. The active v4.0 candidate primitive is a finite
relational-algebraic kernel, presented strictly as a research programme at
evidence class \catmark{D}. The decision is closed under the PI standing
instruction that scientifically determinate dispositions are approved.

\textbf{Scientific basis.} A scalar-gradient construction cannot generate
non-trivial curvature because $\mathrm d^2=0$; a single self-adjoint generator
also yields an abelian generated algebra on which its own inner derivation
vanishes. The manuscript supplies no non-circular bridge from the historical
scalar to the required non-commutative multiplicity structure. Retaining the
scalar as foundational would therefore overstate the available mathematics.

\textbf{Binding conditions.}
(i)~Part~I remains a formal research programme at \catmark{D}, not an
established ontology or theorem corpus.
(ii)~No Standard-Model-like block partition may occur in a core definition,
axiom, hypothesis, loss, or acceptance condition; candidate instances may
occur only downstream of target-independent predicates under GLBC.
(iii)~Historical quantitative results retain their incoming evidence classes
inside Part~III or the museum appendix.

\textbf{Status.} CLOSED on 23~July~2026. This is a governance determination,
not a new physics result and not an evidence-class upgrade.
\end{pioverridebox}
...
\textbf{Historical scope boundary.} At the time of D20,
PI-DELTA-P6, PI-ET-P6, PI-MUSEUM, and P2 were explicitly excluded. They are
resolved separately below by Decisions D21--D24. D20 itself changes no
quantitative value and no evidence class.

\textbf{Application status.} The MSS-000 architecture is present in the
supplied watermarked baseline blob \texttt{7962e5e7}; this finalization patch
preserves D20 and does not authorize merge or freeze.
\end{pioverridebox}

\begin{pioverridebox}[PI Decision D21 --- $\Delta$ Evidence Status (CLOSED)]
\label{box:pi-decision-d21-delta}
\textbf{Decision.} The proposed upgrade of $\Delta=\DeltaGap$ from
\catmark{B} with uncertainty to an exact Class~A value is rejected.
Determination D18 remains controlling: $\Delta=1.710\pm0.015\,\mathrm{GeV}$
is a lattice-compatible reference with no UIDT-internal derivation of the
number and no operator matching to a physical particle observable. It is not
a particle mass and is not identified with the $0^{++}$ glueball.

\textbf{Status.} CLOSED: retain D18 and \catmark{B}. No external
counter-signature is required because no upgrade is made.
\end{pioverridebox}

\begin{pioverridebox}[PI Decision D22 --- $E_T$ Firewall and Class (CLOSED)]
\label{box:pi-decision-d22-et}
\textbf{Decision.} $E_T=\ETorsion$ remains a subatomic reference at
\catmark{E}; the proposed upgrade to Class~C is rejected because no
specified subatomic observable with uncertainty and no validated scale bridge
has been supplied. The MeV-to-neural, biological, cognitive, macroscopic, or
life/death transfer is barred from active v4.0 use unless a separately audited
physical channel, coupling, transfer function, observable, and empirical
protocol are produced.

\textbf{Status.} CLOSED: firewall confirmed; class retained at \catmark{E}.
\end{pioverridebox}

\begin{pioverridebox}[PI Decision D23 --- Historical Scalar Museum (CLOSED)]
\label{box:pi-decision-d23-museum}
\textbf{Decision.} Museum Route~B is final for v4.0. The historical scalar/EFT
material remains in a visibly marked, non-imported appendix. It is preserved
for provenance and regression audit, supplies no premise to Parts~I--III, and
may not be silently deleted or reactivated.

\textbf{Status.} CLOSED: reversible appendix retention approved.
\end{pioverridebox}

\begin{pioverridebox}[PI Decision D24 --- FSS/P2 Disposition (CLOSED BY QUARANTINE)]
\label{box:pi-decision-d24-p2}
\textbf{Decision.} Because the required raw data, immutable run artefacts,
seeds, configuration, and provenance are unavailable, FSS/P2 is placed in
archival quarantine. It contributes no active quantitative claim, no evidence
upgrade, and no manuscript premise. The disposition may be reopened only by a
new PI record after source-faithful raw-data audit. No simulation or result
reconstruction is authorized by this decision.

\textbf{Status.} CLOSED as a governance disposition; the underlying
scientific question remains unresolved.
\end{pioverridebox}

\begin{pioverridebox}[PI Decision D25 --- Programme and Manuscript Name (CLOSED)]
\label{box:pi-decision-d25-name}
\textbf{Decision.} The active v4.0 programme name is
\emph{Relational-Algebraic Pregeometry Programme}. The manuscript title is
\emph{Relational-Algebraic Pregeometry: Finite Kernels, Open Continuum
Emergence, and Formal Verification}. ``Unified Information-Density Theory
(UIDT)'' is retained as the historical name for versions~1--3.9, existing DOI
titles, repository provenance, and legacy notation.

\textbf{Application rule.} The scientific-content patch is audited and
applied before the isolated name-migration patch, so that branding changes do
not obscure substantive review.

\textbf{Status.} CLOSED under the PI's stated agreement with the naming
recommendation.
\end{pioverridebox}

\begin{governancebox}[Name and Provenance Convention]
\ProjectName\ is the active name of the v4.0 research programme. The token
\UIDT\ is retained only for the historical programme lineage, versions
1--3.9, existing DOI titles, repository and path identifiers, quoted legacy
claims, and historical effective-sector notation. A retained UIDT occurrence
therefore does not reactivate the superseded ``Unified Information-Density
Theory'' ontology.
\end{governancebox}
...
\setlength{\parskip}{0.65em plus 0.12em minus 0.04em}%
\setlength{\parindent}{0pt}%
\noindent This manuscript presents a relational-algebraic pregeometry
programme whose active foundational layer contains no classical scalar field,
background spacetime, metric, or smooth-manifold primitive. The candidate
kernel is expressed through finite combinatorial and algebraic data, with the
formal separation
...
The $\mathrm d^2=0$ scalar-gradient obstruction, the unresolved origin of
$G_{\mathrm{SM}}$, the absence of a Born-rule derivation, and the absence of
solutions to the $H_0$ and $S_8$ tensions are retained as explicit
boundaries.
...
capped at \catmark{E} wherever it becomes interpretive. Part~III is a
verification, benchmark, and parameter-ledger stratum rather than active
ontology. It preserves the incoming quantitative content without evidential
upgrade: $\kappa=\KappaRG$\,\catmark{A},
$\lambda_S=\lambdaS$\,\catmark{A}, $v=\vVEV$\,\catmark{A},
$\gamma=\GammaGeom$\,\catmark{A-} as a calibration, and
$\Delta=\DeltaGap$\,\catmark{B} under D18/D21 and Limitation~L12.
Cosmological entries remain calibrations capped at \catmark{C}.

The superseded scalar/EFT architecture is retained in a visibly marked,
non-imported historical appendix. Its Lagrangian, coordinate derivatives,
background metric ansatz, and scalar correlator programme are provenance
records and are not premises of the active architecture. The manuscript
therefore claims a disciplined research programme and a set of localized
obstructions, not a completed derivation of spacetime, the Standard Model, or
...
Every nontrivial claim in this manuscript carries exactly one of six evidence
...
cosmological statement in this manuscript exceeds it, and no statement at
...
triples and Krajewski classification. Stratum~III comprises \RAP\
...
invented or estimated in this manuscript; numerical statements either reproduce
ledger values at their recorded classes or are absent.

\subsection{Provenance of This Manuscript}
\label{subsec:provenance}

This manuscript consolidates: the canonical v3.9.9 manuscript
...
this manuscript; each is carried over at its established evidence class, and the
...
with the corresponding ledger entry in \texttt{LEDGER/CLAIMS.json}. No verified mechanism forcing a stable asymmetric block vacuum is known;
the target-independent construction problem remains an open research
programme at \catmark{D}. Any broader thermodynamic interpretation of that
unknown mechanism remains speculative at \catmark{E}.
...
The removal of the historical scalar ansatz from active ontology under Decisions D19--D20
...
\path{Relational-Algebraic-Pregeometry} (module namespace
\texttt{Antigravit2}), audited for this manuscript at commit
...
audit underlying this manuscript is a \emph{static structural audit} of the
...
/-- Historical software sentinel in the 61bc24da snapshot.
    This definition is not a proof of physical non-identification. -/
def DeltaGlueballConjecture (Delta : Real) : Prop := False
\end{lstlisting}

The second definition is a software sentinel, not a theorem. Defining a
proposition to be \texttt{False} can prevent downstream code from consuming
that proposition, but it does not prove that two physical quantities are
unequal and does not encode the missing operator-matching problem.\catmark{A}
The manuscript therefore relies on Limitation~L12 and Decision~D21, not on
this declaration, for the non-identification boundary. The repository repair
tracked as LEAN-009 must replace the sentinel with typed separation between a
mathematical spectral-gap object, a physical mass observable, and an explicit
operator-matching witness. Statements about literal absence of protected
constants are restricted to the historical \texttt{61bc24da} snapshot until
a live commit tree is reconciled.
...
configuration, and this manuscript uses the Lean form wherever the formal layer
is in view.
\end{remark}

\begin{governancebox}[No Audited ``66 to 7'' Krajewski Reduction in This Draft]
The exhaustive finite enumeration stated in \cref{sec:selection} is the
eleven-element set of sorted integer partitions of $N=6$ under the
declared H1/H2 predicates. It is not an enumeration of sixty-six
Krajewski diagrams. No sixty-six-element starting domain, equivalence
relation, ordered list of fifty-nine eliminations, or seven-survivor
register is supplied in the applied manuscript baseline. Consequently,
this manuscript asserts no ``$66\to7$'' result. A future insertion requires an
immutable starting inventory, target-independent filters, complete
disposition of every eliminated diagram, and a proof-status record for
each formal step; absent any one item, the number remains
\textsc{missing data} rather than a scientific result.\catmark{D}
\end{governancebox}
...
grep-based continuous-integration checks. The policy also fixes the correct reading of every Lean tag in this Part:
unproved formal design structures are \catmark{D}; interpretive physical
readings are separately \catmark{E}. Where a proof is supplied, the proven
proposition is \catmark{A} within the formal system and is not thereby a
physics claim.

\subsection{Historical Static Audit at Head \texttt{61bc24da}}
\label{subsec:formalization-status}

The table below records only the historical static-audit state of commit
\texttt{61bc24da}. ``Closed'' means that no \texttt{sorry} was found in the
named file in that snapshot; it is not a claim about the current repository.
Counts came from a literal whole-word scan and no build was executed.
...
\subsection{Reconciled Lean Snapshot at Head \texttt{f1ae5486}}
\label{subsec:formalization-status-f1ae5486}

The second snapshot is tied only to commit
\texttt{f1ae548633abac7cb47b971917bbab7992801a3f}. It is not a statement
about \texttt{master}, PR~\#24, or any later repository state.

\begin{table}[H]
\centering\small
\begin{tabular}{@{}lp{4.2cm}p{6.4cm}@{}}
\toprule
Audit object & Observation at \texttt{f1ae5486} & Scope and qualification \\
\midrule
Root import graph & 18 reachable modules from \texttt{Antigravit2.lean} &
The source tree contains 22 Lean files; four are outside the root graph.\catmark{A} \\
Environment-qualified build & 18/18 reachable modules exited successfully &
Direct \texttt{lean} invocation with \texttt{LEAN\_PATH} on Windows; 591 seconds; not a pinned-container or complete \texttt{lake build}.\catmark{A} \\
Registered proof debt & 8 occurrences of \texttt{sorry}, all registered &
Five in \texttt{NCG/SpectralTriple.lean} and three in \texttt{Filters/Enumeration.lean}; no register mismatch was found.\catmark{A} \\
Flagship declaration & \texttt{Filters.unique\_321\_N6} has no \texttt{sorryAx} &
Its printed dependency inventory contains \texttt{propext}; this is a formal-software fact, not a physical selection result.\catmark{A} \\
Trust audit & No \texttt{Lean.ofReduceBool} in the supplied inventory &
The avoidance of \texttt{native\_decide} leaves the eight registered obligations open rather than importing that trust path.\catmark{A} \\
\bottomrule
\end{tabular}
\caption{Named-commit Lean reconciliation at \texttt{f1ae5486}. Every row is commit-scoped; the build statement is environment-qualified while PROV-002 remains open.}
\label{tab:lean-status-f1ae5486}
\end{table}

The complete supplied axiom inventory for the named head is:
\begin{lstlisting}[basicstyle=\ttfamily\scriptsize,breaklines=true,columns=fullflexible]
Antigravit2.NCG.reality_JJ                         [propext, Classical.choice, Quot.sound]
Antigravit2.NCG.toSignature_totalDim               [propext]
Antigravit2.MatrixThermo.entropyList_replicate_one [propext, Quot.sound]
Antigravit2.NCG.trivialRealStruct                  [propext, Classical.choice, Quot.sound]
Antigravit2.NCG.trivialFiniteAlgebra               [propext, Classical.choice, Quot.sound]
Antigravit2.Filters.unique_321_N6                  [propext]
Antigravit2.NCG.orientabilityCondition             no additional axioms
Antigravit2.NCG.AdmissibleSpectralTriple           no additional axioms
\end{lstlisting}
This inventory contains neither \texttt{sorryAx} nor
\texttt{Lean.ofReduceBool}.\catmark{A}

\begin{governancebox}[Reachability Boundary and the Latent Krajewski Collision]
The four source modules outside the root import graph at
\texttt{f1ae5486} are \texttt{NCG/Krajewski.lean},
\texttt{Foundation/PrimitiveOperator.lean},
\texttt{Meta/EvidenceTags.lean}, and \texttt{NCG/ModuliStub.lean}.\catmark{A}
The first module's unreachability is why the duplicate Krajewski declaration
is latent at this head: a root-only build does not exercise the conflicting
module.\catmark{A}
The primitive-operator module is also outside the successful set because the
reported environment could not resolve
\texttt{Mathlib.Analysis.CStarAlgebra.Spectrum}; no successful build claim is
made for that file.\catmark{A}
\end{governancebox}

\begin{governancebox}[The Reconciled Head Must Not Be Projected onto \texttt{master}]
At \texttt{master} commit \texttt{07ef753b}, the root build is reported to
fail because \texttt{Bimodule} and \texttt{KrajewskiDiagram} are declared
through conflicting modules.\catmark{A}
The failure is recorded in Issue~\#25 and at two named heads: Ubuntu~24.04
Actions run \texttt{28909958494} (2026-07-08) ran at \texttt{61bc24da}, and
run \texttt{29294970334} (2026-07-14) ran at \texttt{07ef753b}; both logs
report that the environment already contains
\texttt{Antigravit2.NCG.Bimodule.mk} from
\texttt{Antigravit2.NCG.KrajewskiCore}.\catmark{A}
Because \texttt{61bc24da} is an ancestor of \texttt{07ef753b} and is the
historical head documented in \cref{tab:lean-status}, the collision is
evidenced at both commits this manuscript names.\catmark{A}
Those runner-backed failures predate the later account-level CI-start block;
they therefore remain evidence about those two named snapshots,
not about \texttt{f1ae5486} or a future repaired head.\catmark{A}
\end{governancebox}

\begin{governancebox}[Live Lean Status Is Commit-Scoped, Not Projected]
The five GAP-22 artefacts---the commit tree, complete root import graph,
build log, axiom inventory, and whole-repository
\texttt{sorry}/\texttt{admit} scan---are available for the named head
\texttt{f1ae548633abac7cb47b971917bbab7992801a3f}.\catmark{A}
They close the reconciliation requirement only for that commit. Every later
head requires a new five-part snapshot, and no result in
\cref{tab:lean-status-f1ae5486} is projected onto \texttt{master}, PR~\#24,
or an unspecified current state.\catmark{A}
The successful 18-module build remains environment-qualified while PROV-002
is open and does not cover the four unreachable modules.\catmark{A}
\end{governancebox}

\begin{probbox}[Audit Finding F1]{Register--Code Contradiction --- Historical at \texttt{61bc24da}, Reconciled at \texttt{f1ae5486}}
At the historical head \texttt{61bc24da}, the register stated that the
flagship declaration was closed while the theorem body and its verdict
examples still contained \texttt{sorry}; that historical contradiction is
retained in \cref{tab:lean-status}.\catmark{A}
At \texttt{f1ae5486}, the supplied whole-tree scan and declaration inventory
are consistent: \texttt{Antigravit2.Filters.unique\_321\_N6} contains no
\texttt{sorryAx} and reports \texttt{propext} as its dependency.\catmark{A}
This closes F1 only as a documentation and formal-software discrepancy at the
named commit. The proposition still depends on design-level H1 and heuristic
H2, so its physical class remains \catmark{D}; formal closure is not a
physical selection result.
\end{probbox}

\begin{probbox}[Audit Finding F2]{Target-Shaped Admissibility Definition --- Status Open at \texttt{f1ae5486}}
The historical \texttt{61bc24da} audit found a candidate-instance wrapper
whose admissibility condition explicitly matched KO-dimension~6 and the block
list $[3,2,1]$.\catmark{A}
The supplied \texttt{f1ae5486} reconciliation does not include the dedicated
target-shape scan needed to determine whether that wrapper persists, was
repaired, or moved. The status of F2 therefore remains open; absence of an
audit artefact is not evidence of repair.\catmark{D}
No statement in this manuscript treats the formal closure of
\texttt{unique\_321\_N6} as resolving this separate target-leakage question.
\end{probbox}

\begin{probbox}[Audit Finding F3]{Under-Registered Proof Debt --- Historical at \texttt{61bc24da}, Reconciled at \texttt{f1ae5486}}
The historical head contained 51 open obligations and an incomplete register,
as retained in \cref{tab:lean-status}.\catmark{A}
At \texttt{f1ae5486}, the whole-repository scan reports eight occurrences of
\texttt{sorry}: five in \texttt{NCG/SpectralTriple.lean} and three in
\texttt{Filters/Enumeration.lean}. All eight are present in the supplied
register, so the under-registration defect is not present at that named
commit.\catmark{A}
The eight obligations remain proof debt; register consistency records them
honestly and does not close them.
\end{probbox}
...
is not used evidentially anywhere in this manuscript.
...
\begin{proposition}[Conditional $N=6$ selection; physical class \catmark{D}; formal declaration closed at \texttt{f1ae5486}]
...
collapsed. At commit \texttt{f1ae5486}, the declaration
\texttt{Antigravit2.Filters.unique\_321\_N6} has no \texttt{sorryAx} and
its reported dependency inventory is \texttt{[propext]}.\catmark{A}
That is a commit-scoped formal-software statement. The physical content is
still bounded by its weakest hypothesis: design-level H1 and heuristic H2
place the proposition at \catmark{D}, and no completion of the Lean proof
changes that. Only deriving H1 from spectral-triple axioms and replacing H2
by a target-independent stability theorem could alter the physical grade.
The falsification structure remains explicit: weakening H1 admits $[5,1]$
and $[4,2]$; weakening H2 admits $[2,2,1,1]$ and the all-equal partitions.
...
At the historical head \texttt{61bc24da}, the generic filters quantified over
arbitrary partitions while the candidate-instance wrapper triggered Finding~F2.
The supplied \texttt{f1ae5486} materials close the proof-status and
proof-register questions but do not contain the dedicated target-shape scan
needed to adjudicate that wrapper. F2 therefore remains open. Independently of
that unresolved code-location question, the physical selection claim owes its
content to H1 and H2 and remains \catmark{D}.
...
\paragraph{Stabilizer boundary.}
In the cited division-algebraic constructions, the displayed gauge
symmetries are symmetry or stabilizer algebras relative to selected
division-algebraic data: complex structures, ideals, ladder-operator
systems, or subalgebras that the construction requires one to preserve
\cite{furey2018,fureyhughes2022,furey2025}.\catmark{B}
That is a result internal to the chosen algebraic representation; it is
not an endogenous derivation of those data from
\texttt{BlockPartition}, \texttt{FiniteAlgebraSignature}, or the RAP
bridge.\catmark{D}
In particular, an $SU(3)$ stabilizer of octonionic data does not by itself
derive the full $SU(3)_C\times SU(2)_L\times U(1)_Y$ gauge structure,
its hypercharge normalization, chirality, anomaly cancellation, or three
generations. Those remain separate inputs or open obligations in RAP.\catmark{D}
...
floor. The general spectral-gap decision problem is algorithmically undecidable
for broad Hamiltonian classes.\catmark{A} This theorem does not establish
undecidability of a specific UIDT operator. In the present programme, the
operator, infrared floor, and matching map are not constructed; supplying
them without importing the target remains an open design problem at
\catmark{D}.
\end{limitation}
...
point. Any \RAP\ use of the programme must state this exogeneity, and no
...
APP-B-07a & No dynamical origin of the order-one condition is present in the audited corpus & \catmark{A} (audit fact) & a source-faithful construction in the live corpus \\
APP-B-07b & The freezing mechanism remains an open research problem & \catmark{D} & a target-independent principle answering \cref{oq:freezing-gap} under PR-B1/PR-B2 \\
...
that anomaly cancellation selects the $(1,2,3)$ algebra, or that \RAP\
...
G-04a & The stated multiplicity, rank, KO-6 $J$, and chirality conditions are explicit constraints & \catmark{A} (formal statement) & a source or counterexample changing the stated constraints \\
G-04b & Their endogenous selection from the kernel is not derived & \catmark{D} & a target-independent theorem fixing the invariants endogenously \\
G-05 & $[2,2,2]$ rejection rests on an unverified mass-degeneracy
argument & \catmark{D} & primary-source theorem settling the case
either way \\
L-01 & Historical head \texttt{61bc24da}: 51 open obligations and incomplete registration & \catmark{A} & a corrected audit of that exact commit \\
L-02a & Named head \texttt{f1ae5486}: 8 registered \texttt{sorry} occurrences; 18 of 22 source modules reachable from the root & \catmark{A} & a raw rescan or import-graph reconstruction at that exact commit \\
L-02b & F2 target-shape status at \texttt{f1ae5486} remains open because the dedicated scan is absent & \catmark{D} & a commit-scoped target-shape audit \\
S-01a & \texttt{unique\_321\_N6} at \texttt{f1ae5486} has no \texttt{sorryAx} and reports \texttt{[propext]} & \catmark{A} & declaration inspection at that exact commit \\
S-01b & H1 $\wedge$ H2 $\Rightarrow [3,2,1]$ remains physically conditional & \catmark{D} & target-independent derivations replacing both filters \\
...
construction in this manuscript produces a continuum from the kernel; what
...
differentiability consequence is a \RAP\ inference at \catmark{D},
...
asserted is a target-leakage guard: no \RAP\ construction may select the
...
exhibiting a \RAP-compatible construction in which a fundamental time
...
can be stated in one sentence: \RAP\ does not use consciousness as a
...
obligations of empirical science, including uncertainties. \RAP\ adds
...
field's, not \RAP's; the framework cites it and is bound by it.
\item[Stratum~III: The \RAP\ interpretation.] The framework's own
...
the present manuscript the microscopic level is the pregeometric
...
\RAP\ makes the opposite, harder commitment: it states plainly that it
...
produced by \RAP.\catmark{A} Second, the framework has no completed
Born-rule theorem of its own: there is no \RAP\ argument that derives
...
derived by \RAP.\catmark{A} \RAP\ has no completed Born-rule
...
of which structure is forgotten. The \RAP\ forgetful functor has none
...
functor or for any \RAP\ claim.\catmark{A} The direction of inference
...
enter this manuscript at \catmark{E}\ under the present quarantine, with no
...
functor or any \RAP\ claim.\catmark{A} The compression fallacy ---
...
self --- must be treated the same way. \RAP's interpretive proposal,
...
\RAP\ claim; the verified bindings attach with the Phase-P5
...
claimed: \RAP\ does not claim to have solved the problem of qualia; it
...
The developmental corpus assigned the torsion reference
$E_T=\ETorsion$ roles extending from a subatomic effective sector to life,
death, cognition, altered states, and artificial intelligence. Decision~D22
rejects that cross-scale use. In the current manuscript $E_T$ remains a
subatomic phenomenological reference at \catmark{E}; it is not a neural,
biological, cognitive, macroscopic, or life/death threshold.\catmark{E}

The blocking fact is narrower than the historical argument suggested. No
Hamiltonian coupling, operator matching, response function, spectral density,
renormalisation-group matching, transfer function, or intervention protocol is
specified that maps the $E_T$ sector to neural or biological observables. This
absence is a documentable property of the present construction.\catmark{A}
A nominal comparison between mega-electron-volt and electron-volt or
millielectron-volt scales spans roughly six to nine decimal orders, depending
on the chosen observable, but dimensional separation alone is not a universal
no-go theorem. In particular, this manuscript does not claim a model-independent
K\"all\'en--Lehmann suppression factor, does not assert a unique consensus
cross-scale mechanism, and does not infer impossibility from scale separation
alone.\catmark{A}

Any future bridge must introduce the missing mathematical map, identify a
measurable subatomic observable and a distinct low-energy observable, state
all couplings and assumptions independently of the desired phenomenology, and
produce a falsifiable protocol with uncertainties. Constructing such a bridge
is an open research programme at \catmark{D}. Until then every observer-side
interpretation remains quarantined at \catmark{E} and contributes no evidence
to the pregeometric kernel.\catmark{E}

\begin{governancebox}[$E_T$: Subatomic-Only Firewall under D22]
$E_T=\ETorsion$ remains \catmark{E} and subatomic-only. It must not be used as
a threshold for ego, consciousness, life, death, sleep, psychedelic or
near-death states, neural computation, biological regulation, macroscopic
thermodynamics, or artificial general intelligence. No class upgrade is
authorized. Reopening requires a separately audited scale bridge and primary
empirical evidence; verbal analogy is insufficient.
\end{governancebox}
...
design-level answer is negative.\catmark{D} The broader philosophical
claim that no compressor can obtain a unique ontology remains an
interpretive position at \catmark{E}.
...
\RAP\ does not claim to be a final revelation of physics, and could not
...
\textbf{AGI red team.} The programme assigns a superior compressor greater
instrumental capacity but no automatic ontology privilege.\catmark{D}
The Quine--Duhem reading of permanent ontological underdetermination is an
interpretive claim at \catmark{E}.\\[0.3em]
\textbf{No final revelation.} \RAP\ claims representational efficiency, not
...
To locate the \RAP\ observer programme in the wider landscape of theories
...
\RAP\ on precisely the axis where \RAP\ has taken a strong position: it
asserts an \emph{objective physical collapse}, whereas \RAP, in the
...
Three cautions govern the comparison. First, \RAP\ does not collapse all
...
conflated.\catmark{A} Second, \RAP\ does not render orchestrated objective
reduction obsolete; the two are different research programmes on different
premises, and \RAP's denial of objective collapse is a difference of
...
matrix is not built to show that \RAP\ wins; it is built to make the
commitments and the weaknesses of each framework, \RAP\ included, explicit
and comparable along neutral axes.\catmark{A} Throughout, the \RAP\
...
instrument; \RAP\ observer material is \catmark{E}. The matrix records
...
uncomfortable for \RAP, and that discomfort is the point. The observer
...
to flatter \RAP\ would not contain these admissions; their presence is
...
\RAP's QBist no-collapse); not a foil; \RAP\ neither subsumes nor
obsoletes it. This demarcation policy is an audit fact.\catmark{A}
Detailed empirical comparison remains pending citation audit and is capped at
\catmark{E}.\\[0.3em]
...
risk), not a ranking; \RAP\ observer material marked \catmark{E}; \RAP's
own weaknesses recorded explicitly.\catmark{A}
\end{evidencebox}

\subsection{Neuroscience, Consciousness, and the Non-Evidential Observer Boundary}
\label{subsec:ctx-observer-boundary}

The developmental corpus repeatedly compared the observer programme with
predictive processing, Markov-blanket models, integrated-information theory,
global-neuronal-workspace theory, Orch~OR, altered-state phenomenology, and
algebraic-topological descriptions of neural networks. These comparisons are
scientifically useful only when three claims remain separate: a mathematical
description of a biological network, a functional model of cognition, and an
ontological claim about fundamental physics. No result at one level establishes
either of the other two.\catmark{A}

The free-energy principle and active inference provide a formal vocabulary for
statistical boundaries, generative models, and self-maintaining dynamics
\cite{friston2010,kirchhoff2018}.\catmark{B} They do not establish that every
physical boundary is a cognitive observer, and the scope of the Markov-blanket
construction remains contested \cite{raja2021}.\catmark{B} Accordingly, UIDT
uses the Markov blanket only as a bounded comparison for a compression-limited
subsystem. Any identification with mind, agency, or phenomenology remains an
interpretive proposal.\catmark{E}

Algebraic topology has revealed high-order cliques and cavities in simulated
neocortical microcircuits and in human connectomes
\cite{reimann2017,sizemore2018}.\catmark{B} The associated ``dimension'' is
simplicial or homological dimension, not an additional spatial dimension. That
terminological distinction is exact.\catmark{A} These results show that
higher-order relational descriptions can be useful in neuroscience. They do
not confirm the Ramsey-observer ansatz, the \texttt{BlockPartition} formalism,
or a UIDT scale bridge.\catmark{E}

Current consciousness science does not supply a settled theory of phenomenal
experience. A preregistered adversarial collaboration directly tested
predictions of integrated-information theory and global-neuronal-workspace
theory and reported a mixed pattern rather than a unique adjudication
\cite{cogitate2025}.\catmark{B} UIDT is not identified with either theory and
does not inherit their empirical support. Its observer programme presently
supplies no explanation of qualia and no measurable neural prediction.\catmark{E}

Orch~OR proposes quantum-biological processes in neuronal microtubules and an
objective-reduction mechanism associated with space-time geometry
\cite{hameroff2014}.\catmark{B} The proposal has faced substantial criticism
concerning biological feasibility and physical sufficiency
\cite{reimers2014}.\catmark{B} UIDT neither derives nor experimentally refutes
Orch~OR. It differs by assigning no collapse role to consciousness and by
forbidding any unbridged use of the subatomic parameter $E_T$ in neurobiology.
\catmark{E}

Survey research documents vivid entity-encounter reports after inhaled DMT
\cite{davis2020}.\catmark{B} Such reports are data about altered human
experience and interpretation; they are not observations of external entities.
That evidential boundary is independent of the participant's conviction.
\catmark{A} Psychedelic, mystical, dream, near-death, and ``manifestation''
narratives therefore provide no evidence for a UIDT kernel, field, or observer
map.\catmark{E}

\begin{governancebox}[Observer-Context Firewall]
No neural clique, Markov blanket, predictive-processing model, altered-state
report, or quantum-biological hypothesis may upgrade a UIDT claim. A future
observer module must define its source and target structures, physical scale,
state variables, observables, intervention protocol, null model, and downgrade
criterion before it can move from interpretation to a falsifiable programme.
\end{governancebox}
...
T-02a & The manuscript and audited snapshot contain no dimensional-emergence theorem and record UV/IR and thermal-time gaps & \catmark{A} (audit fact) & a contradictory source-faithful corpus audit \\
T-02b & Resolving those continuum-passage gaps remains an open research programme & \catmark{D} & a construction surviving the stated no-go tests \\
T-03a & On the abelian algebra $C^\ast(\mathbf S)$, the stated modular flow is trivial: $\sigma^\omega_t=\mathrm{id}$ & \catmark{A} & a mathematical error in \cref{cor:modular-relocation} \\
T-03b & A thermal-time interpretation requires an inserted non-abelian algebra and non-circular state selection & \catmark{E} & a state-selection principle from pregeometric data without temporal input (\cref{oq:state-selection}) \\
...
\catmark{D} & a \RAP-compatible fundamental time preceding any
thermodynamic state \\
...
O-03 & Born rule borrowed from Stratum~II; no \RAP\ derivation;
functor supplies none & \catmark{A} & a completed non-circular
derivation, externally audited \\
O-04a & No fully specified categories, functor action, or forgotten structure are supplied in the current manuscript & \catmark{A} (audit fact) & a contradictory explicit construction \\
O-04b & $F\colon V\to\mathrm{Obs}$ remains an interpretive ansatz & \catmark{E} & fully specified categories, functor action, and forgotten structure \\
...
E-01a & Governance bars $E_T$ from cognitive, biological, or life/death threshold roles under Decision D22 & \catmark{A} (policy) & a superseding PI record \\
E-01b & No validated physical scale bridge from the subatomic $E_T$ sector to neural observables is supplied & \catmark{D} & a constructed, externally audited scale bridge \\
...
OT-01a & Observer Classes 0--III form an interpretive compression-rate taxonomy, not a consciousness hierarchy & \catmark{E} & an operational empirical model \\
OT-01b & The programme grants no evidential privilege merely from superior compression & \catmark{A} (governance policy) & a superseding policy record \\
DM-01 & Demarcation matrix is a neutral instrument recording \RAP's own
...
quantities from within \RAP; benchmark values are stored with solver
...
\begin{pioverridebox}[PI Decisions D18/D21 --- Evidence-Class Determination for $\Delta$]
\label{box:pi-override-delta}
The value $\Delta=\DeltaGap$ remains at Class~\catmark{B}: an internally
consistent, lattice-compatible reference under the recorded determination,
not a UIDT-internal derivation and not an exact mathematical theorem for the
numerical value. Decision D21 rejects the proposed upgrade to Class~A; no
external counter-signature is sought because no upgrade occurs. The class of
the value does not identify it with a particle state. Limitation~L12 bars any
$0^{++}$ glueball or particle-mass identification without an explicit
operator and correlator matching.
\end{pioverridebox}
...
to compute $\gamma$, $\Delta$, or related quantities from within \RAP.
...
\label{lim:L12}
The \RAP\ spectral gap $\Delta$ must not be identified with the mass of
...
L1--L7 and L12--L15 remain historically anchored. Entries L8--L11 below
are newly issued limitation statements derived from the applied
manuscript's explicit formal boundaries; they are not presented as
recovered quotations from the missing developmental notes. Their status
is therefore provenance-clean: replacement statements, not reconstructed
history.\catmark{A}
...
$E_T = \ETorsion$; the latter is a separate subatomic reference with no
constructed observer, neural, biological, or macroscopic scale bridge
(\cref{subsec:et-scale-bridge}). The value of $\Lambda_{\UIDT}$
is not fixed and a non-perturbative UV completion remains
open.\catmark{D}
\end{limitation}

\begin{limitation}[L8: Algebraic identities do not select a partition]
\label{lim:L8}
The block-thermodynamic relations collected in this manuscript constrain
bookkeeping among block sizes, diagonal sectors, off-diagonal sectors,
and entropy terms. No target-independent functional is supplied whose
global minimiser uniquely selects $[3,2,1]$. An exact decomposition or
conservation identity is therefore an internal consistency relation, not
a dynamical selection theorem. Any future selector must be fixed before
the candidate is evaluated and must survive sealed null controls under
\cref{prop:target-leakage}.\catmark{D}
\end{limitation}

\begin{limitation}[L9: H1/H2 are conditional filters, not derived laws]
\label{lim:L9}
The conditional $N=6$ proposition depends entirely on H1 and H2.
H1 is a design-level extrapolation from intersection-form constraints;
H2 is a heuristic proxy for non-degenerate fermion masses. Their finite
filtering power is auditable, but neither predicate is derived from the
pregeometric kernel or from a free-energy stability theorem. Completion
of the Lean checker would certify only the implication
$\mathrm{H1}\wedge\mathrm{H2}\Rightarrow[3,2,1]$ over the declared finite
domain; it would not upgrade the physical selection claim above
\catmark{D}.
\end{limitation}

\begin{limitation}[L10: Finite $N=6$ enumeration is not large-$N$ dynamics]
\label{lim:L10}
Exhaustive enumeration of the eleven sorted integer partitions of $6$
establishes, at most, completeness and filter verdicts for that finite
candidate set. It does not establish a thermodynamic limit, a
large-$N$ phase transition, continuum emergence, spontaneous
Wedderburn splitting, or asymptotic selection of gauge symmetries.
Claims of that kind require a separately defined dynamics, scaling
regime, and target-independent convergence criterion.\catmark{D}
\end{limitation}

\begin{limitation}[L11: The formal bridge is structure-losing and incomplete]
\label{lim:L11}
The current bridge transfers a combinatorial block list into abstract
finite-algebra and spectral-triple records through derived dimensions
and axiomatic markers. It does not establish an equivalence with the
classification of finite real spectral triples, and it does not
endogenously supply bimodule multiplicities, chirality, Krajewski edges,
a physical representation, or analytic spectral-triple axioms. Any
conversion through a generic number-partition representation additionally
forgets ordering or labels unless those data are restored and proved
invariant. The bridge is therefore scaffolding for a formal programme,
not a completeness theorem for noncommutative geometry.\catmark{D}
\end{limitation}
...
\noindent The register is complete in enumeration. L1--L7 and
L12--L15 preserve the historical anchored entries; L8--L11 are explicitly
identified as newly issued replacement limitations and carry no claim of
verbatim recovery from the missing notes.\catmark{A}
...
\begin{table}[H]
\footnotesize
\caption{Stratum-I empirical inputs to which \RAP\ calibrates. All
...
limits this manuscript has doubled down on: the $d^2=0$ obstruction
...
validate \RAP\ beyond calibrated Category~\catmark{C}\
status.\\[0.3em]
...
rather than reconciled by selection.\catmark{A} T8 is new in this manuscript
...
\noindent The three parts of this manuscript have stated what the framework
...
mathematical structure raises an epistemological question: does \RAP\
...
a stated minimality argument. In this manuscript that Lagrangian describes the
...
\RAP\ posits no external simulator and no computational substrate.
...
It is useful, and disciplined, to state where \RAP\ sits relative to
established programmes, always as comparison, never as a claim of
superiority.

Against string theory, \RAP\ is far more ontologically frugal but
...
\RAP\ shares the intuition that geometry is emergent and thermodynamic
...
loop quantum gravity, \RAP\ shares the \emph{aspiration} to background
...
particle content --- indeed \RAP\ has not recovered it at all, which is
the content of the open gap.\catmark{E}

Two comparisons are new to this manuscript, and both are unflattering. Against
...
geometries --- is imported, and \RAP\ has added no theorem to that
...
The general move that \RAP\ makes --- taking an information-theoretic
...
Stratum-II\,\catmark{B} result \emph{within} AdS/CFT; \RAP\ has no
...
derivations imported into \RAP. \catmark{A} re: corpus (as a statement
about what \RAP\ does and does not derive); \catmark{E} for the mapping.
\end{evidencebox}

\noindent Against this background, what is specific to \RAP\ --- and
...
leaves open; they are the specific, falsifiable form in which \RAP\
states its version of it.\catmark{E}

\section{Scientific Context and Reciprocal Demarcation}
\label{sec:ctx-scientific-context}

The developmental chat is treated here as a question inventory, not as a
scientific source. Its useful content consists of candidate comparisons,
objections, and missing bridges. Every external statement below is grounded in
a primary or peer-reviewed source rather than in the chat response that first
raised it.\catmark{A}

\subsection{The Non-Anthropocentric Lens as Method}
\label{subsec:ctx-nonanthropocentric-method}

The ``non-anthropocentric lens'' is retained as a methodological instruction:
do not infer primitive ontology from perceptual salience, biological utility,
mathematical familiarity, aesthetic preference, or human-scale language.
\catmark{E} It is not a theorem that space, time, objects, causality, or
continuity are illusions. UIDT has not derived the conditions under which those
structures emerge or fail.\catmark{A}

The defensible content is type discipline. If a concept is absent from the
primitive signature, it cannot be used at that level without a declared bridge.
\catmark{A} This rule blocks background spacetime, observers, temperatures,
particles, and continuum fields from being smuggled into the Phase-6 kernel. It
does not establish that the present finite algebraic candidate is the final
ontology.\catmark{E}

The stronger developmental thesis that all scientific progress consists in the
destruction of category errors is rejected. A narrower historical claim is
sustainable: progress often requires separating variables, objects, and
explanations that belong to different domains or effective levels.\catmark{B}
UIDT applies that diagnostic to itself by preserving its scalar history while
removing that history from the active primitive layer.\catmark{E}

\subsection{Structural Realism and Underdetermination}
\label{subsec:ctx-structural-realism}

Ontic structural realism interprets modern physics as favouring relations and
structures over independently individuated fundamental objects
\cite{frenchladyman2003,ladymanross2007}.\catmark{E} UIDT is compatible with
that orientation, but it neither follows from nor confirms structural realism.
OSR selects no \texttt{BlockPartition}, spectral triple, Krajewski diagram,
thermodynamic functional, or parameter value.\catmark{A}

The reciprocal relation is methodological. Structural realism supplies a
vocabulary for structure-dependent objecthood; UIDT supplies a concrete but
unverified formal candidate on which that vocabulary can be stress-tested.
\catmark{E} Underdetermination remains binding: predictive equivalence or
compression efficiency does not uniquely select ontology.\catmark{E}

\subsection{Pregeometry and Quantum-Gravity Neighbours}
\label{subsec:ctx-qg-neighbours}

Causal-set theory, loop quantum gravity, spin foams, group field theory, tensor
networks, holography, matrix models, and noncommutative geometry contain serious
programmes in which continuum spacetime is non-fundamental, discrete,
algebraic, quantum, or emergent
\cite{bombelli1987,sorkin2003,rovelli2011,gielen2016,swingle2012,vanraamsdonk2010,ikkt1997,steinacker2010}.
\catmark{B} Their existence makes non-fundamental-continuum research
scientifically legitimate. It provides no evidence for UIDT's specific kernel
or bridge.\catmark{A}

The differences are structural. Causal sets begin from causal order and local
finiteness; loop approaches quantize geometric observables; group field theory
uses field-theoretic quanta of geometry; holographic and tensor-network models
relate entanglement to geometry in specified regimes; matrix models derive
candidate geometries from matrix dynamics; UIDT instead proposes a finite
relational-algebraic kernel and leaves the continuum passage open.\catmark{B}
No equivalence functor, shared universality class, or common renormalisation
trajectory has been constructed between UIDT and any of these programmes.
\catmark{D}

Jacobson, Padmanabhan, and Verlinde are precedents for thermodynamic or entropic
reformulations of gravitational dynamics
\cite{jacobson1995,padmanabhan2010,verlinde2011}.\catmark{B} UIDT does not
recover their horizon assumptions, thermodynamic variables, or Einstein
dynamics from its kernel.\catmark{A}

\subsection{Noncommutative Geometry, Division Algebras, and the Gauge-Origin Gap}
\label{subsec:ctx-gauge-origin}

Noncommutative geometry supplies the mature language from which UIDT imports
finite spectral triples, real structures, KO-dimension, first-order
conditions, Krajewski combinatorics, and spectral-action methods
\cite{connes2006,cc2008,vansuijlekom2019}.\catmark{B} Standard-Model
structures can be recovered within that programme under substantial geometric
and representation-theoretic assumptions. UIDT has not derived those
assumptions from a prior featureless substrate.\catmark{A}

Division-algebra programmes use complex, quaternionic, and octonionic
structures to organise Standard-Model representations and symmetry breaking
\cite{furey2018,todorov2022,fureyhughes2022,gourlay2024}.\catmark{B} These
results are candidate constraints on an internal algebra. They do not show that
UIDT generates the division algebras, selects exactly three generations, or
satisfies G1--G4 without inserted target structure.\catmark{A}

The scalar-gradient obstruction is narrow and exact: for an ordinary scalar
function, $A=dS$ implies $F=dA=d^2S=0$.\catmark{A} It excludes one route from
a scalar gradient to non-trivial curvature. It does not refute scalar fields,
scalar-tensor gravity, Higgs sectors, inflationary models, or emergent gauge
fields produced by richer systems.\catmark{A}

\subsection{Information, Computation, and the Status of the Meta-Equation}
\label{subsec:ctx-information-computation}

Shannon information theory defines entropy, channel capacity, coding limits,
and communication rates for specified ensembles and channels
\cite{shannon1948}.\catmark{A} It does not entail that information is a
substance or that the universe is fundamentally a communication channel.
\catmark{A} Wheeler's information-first language remains a historically
important research heuristic, not a derivation of UIDT.\catmark{E}

The spectral-gap undecidability theorem of Cubitt, P\'erez-Garc\'ia, and Wolf
applies to a precisely constructed class of infinite, translationally invariant
quantum lattice systems \cite{cubitt2015}.\catmark{A} It does not prove that
all physical systems, all Yang--Mills gaps, or the UIDT kernel are
computationally irreducible.\catmark{A}

The developmental expressions $K(\mathcal A_E)\gg C(O)$ and an
$\operatorname*{arg\,min}D_{\mathrm{KL}}$ ``master equation'' are therefore
not admitted as equations of motion or derived bounds. Their variables,
probability spaces, units, dynamics, existence conditions, and uniqueness
conditions were never defined.\catmark{A} They may be retained only as a prose
schema: a finite subsystem generally uses reduced representations of a larger
environment. Any quantitative inequality remains an open construction.
\catmark{E}

Ramsey theory guarantees ordered substructures in sufficiently large graphs
under specified colouring conditions.\catmark{A} It does not establish that
observers are Ramsey cliques, that cognition is forced by a Ramsey number, or
that the UIDT kernel generates biological observers.\catmark{A}

\subsection{Relational Time and the Scope of Analogue Experiments}
\label{subsec:ctx-relational-time}

The thermal-time hypothesis and Page--Wootters-type constructions show that
internal or state-dependent temporal order can be formulated in precise
operator-algebraic and quantum settings
\cite{connesrovelli1994,pagewootters1983}.\catmark{B} A 2026 cold-atom
experiment constructed an entropic internal time for a partitioned Bose--Einstein
condensate and used it to order subsystem dynamics
\cite{barontini2026}.\catmark{B} This is a controlled analogue test of a
relational-time construction. It is not evidence that UIDT's kernel generates
time, and it does not resolve the manuscript's non-circular state-selection
problem.\catmark{A}

\subsection{Quantum Probability and the Born-Rule Boundary}
\label{subsec:ctx-born-boundary}

Gleason-type theorems derive the density-operator probability form from
specified Hilbert-space, projection, additivity, and compositional assumptions
\cite{gleason1957,frembs2023,fiorentino2026}.\catmark{A} These results clarify
what a mathematical Born-rule theorem requires. They do not derive the Hilbert
space, projection lattice, composition rule, or probability measure from the
UIDT pregeometric kernel.\catmark{A} The Born rule therefore remains a
Stratum-II import unless a separate bridge is constructed.\catmark{D}

\subsection{Reciprocal Demarcation}
\label{subsec:ctx-reciprocal-demarcation}

Descriptions of established external programmes are carried at
\catmark{B}. UIDT-specific mappings are carried at \catmark{E}. Statements
that no bridge is present in the current corpus are document-level facts at
\catmark{A}.
...
\toprule
\textbf{Programme} & \textbf{Established contribution} &
\textbf{UIDT relation and non-inference}\\
\midrule
Ontic structural realism & Relation-first metaphysical interpretation &
Compatible vocabulary; no selection or validation of the UIDT kernel.\\
Noncommutative geometry & Finite spectral triples and spectral action &
Primary formal source language; UIDT does not derive its assumptions.\\
Causal sets / loop / GFT & Discrete or quantum-geometric programmes &
Neighbouring research directions; no shared continuum theorem.\\
Tensor networks / holography & Entanglement--geometry relations in defined regimes &
Useful coarse-graining comparator; no universal entanglement--space identity.\\
Matrix models & Matrix dynamics and candidate emergent geometries &
Closest dynamical neighbour; no target-independent UIDT selection theorem.\\
Thermodynamic gravity & State-equation and entropy-based gravitational reformulations &
Precedent only; no Einstein-equation derivation from UIDT block data.\\
Division algebras & Structured particle-representation programmes &
Candidate constraints; no endogenous selection or generation theorem.\\
FEP / predictive processing & Statistical boundaries and generative control &
Functional observer analogy; no fundamental observer or qualia theorem.\\
IIT / GNWT & Empirically testable consciousness theories &
Neutral comparators; no identification with UIDT observer language.\\
Orch~OR & Quantum-biological objective-reduction proposal &
Neither adopted nor refuted; no microtubule or quantum-gravity bridge.\\
Psychedelic research & Reports and neural correlates of altered experience &
Phenomenology only; no fundamental-physics evidence.\\
Gleason programmes & Quantum probability from stated structural assumptions &
Clarify missing premises; do not close the UIDT Born-rule gap.\\
\bottomrule
\end{tabular}
\caption{Reciprocal scientific demarcation. Similarity, precedent, or shared
vocabulary does not constitute confirmation.}
\label{tab:ctx-reciprocal-demarcation}
\end{table}
...
that quietly declares victory. This manuscript runs the test twice: once against the v3.9 scalar claim it
...
\section{UIDT v4.0 Research-Gap Atlas}
\label{sec:ctx-v4-gap-atlas}

The atlas distinguishes missing definitions, missing theorems, missing
physical bridges, missing data, and unresolved governance actions. A gap is
not evidence against the programme by itself; concealing or misclassifying it
would be.\catmark{A}

\begin{longtable}{@{}p{1.05cm}p{4.15cm}p{6.45cm}p{1.05cm}@{}}
\toprule
\textbf{ID} & \textbf{Open object} & \textbf{Closure condition} &
\textbf{Class}\\
\midrule
\endfirsthead
\toprule
...
\midrule
\endhead
GAP-01 & Primitive selection & Target-independent construction or a
non-uniqueness theorem over an explicit admissible class. & \catmark{D}\\
GAP-02 & $G_{\mathrm{SM}}$ origin & Gauge algebra, representations, chirality,
anomalies, and generations derived without target insertion. & \catmark{D}\\
GAP-03 & G1--G4 joint satisfiability & Constructed mechanism satisfying all
four conditions with proofs and falsification cases. & \catmark{D}\\
GAP-04 & Generation number & Endogenous selection of exactly three generations.
& \catmark{D}\\
GAP-05 & Kernel dynamics & Target-blind action, state space, transition law,
and measure. & \catmark{D}\\
GAP-06 & Continuum limit & Controlled convergence of observables and a
universality or renormalisation result. & \catmark{D}\\
GAP-07 & Dimension emergence & Selection theorem that does not encode the
requested dimension. & \catmark{D}\\
GAP-08 & Lorentzian signature & Target-independent mechanism yielding causal
and signature structure. & \catmark{D}\\
GAP-09 & Time and state selection & Non-temporal selection principle for the
state whose flow has physical temporal meaning. & \catmark{D}\\
GAP-10 & UV/IR decoupling & Proof that microscopic structure yields the
required low-energy locality and suppresses contamination. & \catmark{D}\\
GAP-11 & Observer map & Explicit domains, morphisms, functor laws, physical
implementation, observables, and interventions. & \catmark{D}\\
GAP-12 & Born rule & Kernel-to-quantum bridge satisfying the assumptions of a
Gleason-type theorem, or permanent import status. & \catmark{D}\\
GAP-13 & Consciousness boundary & Falsifiable observer-level model without a
qualia, collapse, or fundamental-experience overclaim. & \catmark{E}\\
GAP-14 & Biological scale bridge & Physical channel from subatomic quantities
to neural observables with noise and decoupling analysis. & \catmark{D}\\
GAP-15 & Yang--Mills operator matching & Operator and correlator map from the
internal gap object to a consensus Yang--Mills observable. & \catmark{D}\\
GAP-16 & $\gamma$ origin & Blind, preregistered mechanism independent of the
calibrated value. & \catmark{D}\\
GAP-17 & Effective-sector derivation & Coarse-graining theorem explaining why
an EFT and its parameters follow from the kernel. & \catmark{D}\\
GAP-18 & Cosmological dynamics & Equations and likelihood predictions for CMB,
BAO, supernovae, lensing, and structure growth. & \catmark{D}\\
GAP-19 & Matter--antimatter asymmetry & Sakharov-complete quantitative
baryogenesis or leptogenesis mechanism. & \catmark{D}\\
GAP-20 & Black-hole sector & Defined singularity, entropy, evaporation, and
information-recovery model. & \catmark{D}\\
GAP-21 & Vacuum extraction & Protocol compatible with passivity, quantum
inequalities, conservation, and backreaction. & \catmark{D}\\
GAP-22 & Lean reconciliation at \texttt{f1ae5486} & Five-part snapshot and line-by-line adjudication completed for the named commit; every later head requires a fresh reconciliation. & \catmark{A}\\
GAP-23 & NORM-01 & Single-class decomposition of compound claims; closed by this content-finalization patch, subject to Claude diff audit. & \catmark{A}\\
GAP-24 & PROV-002 & Immutable TeX image digest, source lock, negative fixtures,
and deterministic report. & \catmark{A}\\
GAP-25 & Governance enforcement & Non-empty PR-range gates, protected branch,
human PI sign-off, and required external counter-signature. & \catmark{A}\\
GAP-26 & Source authority & Claim graph separating chat, hypothesis, source,
raw data, code, derived artefact, and manuscript statement. & \catmark{A}\\
GAP-27 & External replication & Independent formal and numerical reproduction
on a separately controlled system. & \catmark{D}\\
GAP-28 & FSS/P2 scientific result & Active use is quarantined under Decision D24; the scientific question remains open pending raw data. & \catmark{D}\\
\bottomrule
\caption{UIDT v4.0 research-gap atlas.}
\label{tab:ctx-v4-gap-atlas}
\end{longtable}

\begin{governancebox}[Gap Closure Rule]
No gap is closed by analogy, numerical proximity, AI agreement, successful
compilation alone, or agreement with a theory that starts from different
primitives. Closure requires the mathematical, empirical, provenance, or
governance object stated in the relevant row.
\end{governancebox}

\section{Reproduction Note}
\label{sec:reproduction-note}

\noindent Every quantitative and formal statement in this manuscript is
...
\end{verbatim}
No other numerical value in this manuscript is computed here; ledger values
...
Part~I now records two non-interchangeable repository states. The historical
table at \texttt{61bc24da} remains a static whole-word scan for which no build
was executed. The reconciled table at \texttt{f1ae5486} records the supplied
commit tree, root import graph, environment-qualified 18-module build, axiom
inventory, and whole-repository proof-debt scan. Reproduction requires
fetching the named commit and repeating those exact operations. Neither
snapshot is projected onto \texttt{master} or a later head, and the successful
build does not constitute a physics result.
...
\noindent The bibliography of this manuscript is the verified bibliography of
...
rests, in this manuscript, on Chamseddine--Connes--Marcolli~\cite{ccm2007},
...
\noindent No source is cited in this manuscript for more than it claims.
...
required by future additions to this manuscript must pass a DOI or arXiv
...
\catmark{D} (programme) & K-01, G-05, S-01, S-02, C-01, C-02, L8--L11 & T-01, T-02 & ONT-08, ONT-11 \\
\catmark{E} (interpretive/museum) & quarantined audit doc & O-02, O-04 & ONT-10, L6 \\
\bottomrule
\end{tabular}
...
\catmark{D} in any part of this manuscript. The classes above \catmark{D} are
...
\section{Ledger Record: PI Decision D19}
\label{sec:d19-ledger-record}

\begin{pioverridebox}[D19 --- Ledger Record: Ontological Re-Architecture]
\textbf{Decision.} The continuous real scalar field $\Sx$ is demoted from
ontological primitive to a historical macroscopic effective-field model. A
finite relational-algebraic pregeometric kernel is the active candidate under
investigation at evidence class \catmark{D}.

\textbf{Binding conditions.}
(i)~Part~I is a formal research programme at \catmark{D}, not an established
foundation.
(ii)~No target block partition is permitted in core definitions, axioms,
hypotheses, losses, or acceptance conditions.
(iii)~Historical ledger values retain their recorded classes:
$\kappa = \KappaRG$\,\catmark{A}, $\lambda_S = \lambdaS$\,\catmark{A},
$v = \vVEV$\,\catmark{A}, $\gamma = \GammaGeom$\,\catmark{A-},
$\Delta = \DeltaGap$\,\catmark{B} under D18/D21, and cosmological entries
at no higher than \catmark{C}.

\textbf{Status.} CLOSED on 23~July~2026 under the PI standing instruction for
scientifically determinate decisions. No constant is reclassified by D19.
\end{pioverridebox}
...
(iv)~PI-DELTA-P6, PI-ET-P6, PI-MUSEUM, and P2 were separate decisions at D20 and are subsequently closed by D21--D24.

\textbf{Application record.} The MSS-000 rebase was audited against blob
\texttt{601cc57d} and is present in the supplied watermarked baseline blob
\texttt{7962e5e7}. This statement records manuscript provenance only; final
integration and merge remain PI-only.
\end{pioverridebox}

\section{Closed PI Dispositions D21--D25}
\label{sec:closed-pi-dispositions}

\begin{description}[leftmargin=2.8cm,style=nextline]
\item[D21 --- $\Delta$.] Upgrade rejected; D18 retained at
$1.710\pm0.015\,\mathrm{GeV}$ and \catmark{B}. No particle-mass or glueball
identification.
\item[D22 --- $E_T$.] Scale firewall confirmed; class retained at
\catmark{E}; no neural, biological, cognitive, macroscopic, or life/death
application without a separately audited scale bridge.
\item[D23 --- Museum.] Route~B approved as the final v4.0 historical-retention
route. The appendix is non-imported and reversible.
\item[D24 --- P2.] FSS/P2 placed in archival quarantine because raw data and
run provenance are absent. No active claim survives the quarantine.
\item[D25 --- Name.] Active programme and manuscript names approved by Decision D25; UIDT remains the historical lineage name.
\end{description}

\section*{Open Obligations Carried Forward}
\addcontentsline{toc}{section}{Open Obligations Carried Forward}

\noindent The following are recorded so that no reader of this manuscript
mistakes its completeness for closure.

\begin{enumerate}[leftmargin=1.6em,itemsep=0.25em]
\item Lean findings F1 and F3 are reconciled for the named head
\texttt{f1ae5486}: the flagship declaration has no \texttt{sorryAx}, and the
eight remaining \texttt{sorry} occurrences are all registered. F2 remains
open because no dedicated target-shape scan was supplied. Four modules remain
outside the successful root build, and every later head requires a fresh
reconciliation. These facts alter only the formal software record; physical
claims remain bounded by their hypotheses.
...
\item The Born rule, a physical $E_T$ scale bridge, the $H_0$ and $S_8$
tensions, and the origin of $G_{\mathrm{SM}}$ remain unresolved. Decision
D22 closes only the misuse boundary, not the missing scale bridge; Decision
D24 closes only the active use of P2, not its scientific question.
\item No ``$66\to7$'' Krajewski reduction is part of this manuscript
without the complete starting inventory and elimination ledger required in
\cref{subsec:krajewski}. Division-algebra stabilizers remain imported
comparators, not a derivation from the RAP kernel.
\end{enumerate}


\clearpage
\appendix
\toggletrue{museumwatermark}
...
\begin{governancebox}[Museum Route B --- Final Reversible Retention under D23]
...
not active primitives, operators, acceptance conditions, or derivations.
Decision D23 fixes Route~B for v4.0: the record is retained, non-imported, and
may not be silently deleted or reactivated. Any later relocation requires a
new separately audited PI record.
\end{governancebox}
...
density, of canonical mass dimension $[\LegacySx]=1$. Under PI Decision D19, $\LegacySx$ is \emph{not} an ontological primitive: it is postulated
...
% CTX-001 scientific-context bibliography additions
\bibitem{frenchladyman2003}
S.~French, J.~Ladyman, ``Remodelling structural realism: Quantum physics and
the metaphysics of structure,'' Synthese \textbf{136} (2003) 31--56.
DOI 10.1023/A:1024156116636.

\bibitem{ladymanross2007}
J.~Ladyman, D.~Ross, with D.~Spurrett and J.~Collier,
\textit{Every Thing Must Go: Metaphysics Naturalized}, Oxford University
Press (2007). DOI 10.1093/acprof:oso/9780199276196.001.0001.
...
\bibitem{sorkin2003}
R.~D.~Sorkin, ``Causal sets: Discrete gravity,'' in A.~Gomberoff and
D.~Marolf (eds.), \textit{Lectures on Quantum Gravity}, Springer (2005),
pp.~305--327. arXiv:gr-qc/0309009.

\bibitem{rovelli2011}
C.~Rovelli, ``Loop quantum gravity: the first twenty-five years,''
Class.\ Quantum Grav.\ \textbf{28} (2011) 153002.
arXiv:1012.4707. DOI 10.1088/0264-9381/28/15/153002.

\bibitem{gielen2016}
S.~Gielen, L.~Sindoni, ``Quantum cosmology from group field theory
condensates: a review,'' SIGMA \textbf{12} (2016) 082.
arXiv:1602.08104. DOI 10.3842/SIGMA.2016.082.

\bibitem{swingle2012}
B.~Swingle, ``Constructing holographic spacetimes using entanglement
renormalization,'' arXiv:1209.3304 (2012).
...
M.~Kirchhoff, T.~Parr, E.~Palacios, K.~Friston, J.~Kiverstein,
``The Markov blankets of life: autonomy, active inference and the free-energy
principle,'' J.\ R.\ Soc.\ Interface \textbf{15} (2018) 20170792.
DOI 10.1098/rsif.2017.0792.

\bibitem{raja2021}
V.~Raja, D.~Valluri, E.~Baggs, A.~Chemero, M.~L.~Anderson,
``The Markov blanket trick: On the scope of the free energy principle and
active inference,'' Phys.\ Life Rev.\ \textbf{39} (2021) 49--72.
DOI 10.1016/j.plrev.2021.09.001.

\bibitem{reimann2017}
M.~W.~Reimann et al., ``Cliques of neurons bound into cavities provide a
missing link between structure and function,'' Front.\ Comput.\ Neurosci.\
\textbf{11} (2017) 48. DOI 10.3389/fncom.2017.00048.

\bibitem{sizemore2018}
A.~E.~Sizemore et al., ``Cliques and cavities in the human connectome,''
J.\ Comput.\ Neurosci.\ \textbf{44} (2018) 115--145.
DOI 10.1007/s10827-017-0672-6.

\bibitem{cogitate2025}
Cogitate Consortium et al., ``Adversarial testing of global neuronal
workspace and integrated information theories of consciousness,''
Nature \textbf{642} (2025) 133--142.
DOI 10.1038/s41586-025-08888-1.

\bibitem{reimers2014}
J.~R.~Reimers, L.~K.~McKemmish, R.~H.~McKenzie, A.~E.~Mark, N.~S.~Hush,
``The revised Penrose--Hameroff orchestrated objective-reduction proposal
for human consciousness is not scientifically justified,'' Phys.\ Life Rev.\
\textbf{11} (2014) 101--103. DOI 10.1016/j.plrev.2013.11.003.

\bibitem{davis2020}
A.~K.~Davis, J.~M.~Clifton, E.~G.~Weaver, E.~S.~Hurwitz,
M.~W.~Johnson, R.~R.~Griffiths, ``Survey of entity encounter experiences
occasioned by inhaled N,N-dimethyltryptamine: phenomenology,
interpretation, and enduring effects,'' J.\ Psychopharmacol.\
\textbf{34} (2020) 1008--1020. DOI 10.1177/0269881120916143.
...
\bibitem{frembs2023}
M.~Frembs, A.~D\"oring, ``Gleason's theorem for composite systems,''
J.\ Phys.\ A: Math.\ Theor.\ \textbf{56} (2023) 445303.
arXiv:2205.00493. DOI 10.1088/1751-8121/acfbcb.

\bibitem{fiorentino2026}
V.~Fiorentino, S.~Weigert, ``Gleason's theorem for a qubit as part of a
composite system,'' Phys.\ Rev.\ A \textbf{113} (2026) 062221.
arXiv:2511.15607. DOI 10.1103/8dyw-6ktq.

\bibitem{pagewootters1983}
D.~N.~Page, W.~K.~Wootters, ``Evolution without evolution: Dynamics
described by stationary observables,'' Phys.\ Rev.\ D \textbf{27} (1983)
2885--2892. DOI 10.1103/PhysRevD.27.2885.

\bibitem{barontini2026}
G.~Barontini, ``Testing the problem of time with cold atoms,''
Phys.\ Rev.\ Research \textbf{8} (2026) L022047.
arXiv:2509.07745. DOI 10.1103/1h9j-df4k.

\bibitem{todorov2022}
I.~Todorov, ``Octonion internal space algebra for the Standard Model,''
Universe \textbf{8} (2022) 318. arXiv:2206.06912.
DOI 10.3390/universe8060318.

\bibitem{fureyhughes2022}
C.~Furey, M.~J.~Hughes, ``Division algebraic symmetry breaking,''
Phys.\ Lett.\ B \textbf{835} (2022) 137492.
arXiv:2210.10126. DOI 10.1016/j.physletb.2022.137492.
