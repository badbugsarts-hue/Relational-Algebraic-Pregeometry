%=============================================================================
% Relational-Algebraic Pregeometry Programme (RAP) v4.0
% Author: Philipp Rietz (ORCID: 0009-0007-4307-1609)
% DOI (Ontology): 10.5281/zenodo.20319634
...
% authorization, NOT a canonical freeze, NOT a proof of RAP, and NOT an
...
\clearpage
\appendix
\section{Research Governance \& Architectural Decisions (D19--D25)}
\label{app:pi-decisions}

The following architectural decisions and PI override directives govern the structural transition from the historical framework (UIDT v3.9) to the formal pregeometry programme (RAP v4.0). They are preserved here to maintain strict provenance and an auditable research ontology.
